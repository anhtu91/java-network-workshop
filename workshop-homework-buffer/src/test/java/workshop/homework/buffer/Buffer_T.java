...
public class Buffer_T {
	...
	public static void testCaseThreeFIFO() {
		...
		try {
			/*Create a buffer with 10 elemnts*/
			b = new Buffer(10, false);
	...
	public static void main(String [] args) {
		...
		logger.info(String.format("Test cases FIFO"));
		//Test cases FIFO
		testCaseOneFIFO();
		System.out.println();
		testCaseTwoFIFO();
		...
		logger.info(String.format("Test cases Ring Buffer"));
