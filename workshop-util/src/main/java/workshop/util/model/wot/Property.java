...
public class Property<T> {
     ...
     */
    private void validateValue(T value) throws IllegalArgumentException {
        if (this.metadata.has("readOnly") &&
                this.metadata.getBoolean("readOnly")) {
            throw new IllegalArgumentException("Read-only property");
        }
     ...
     * @throws IllegalArgumentException If value could not be set.
     */
